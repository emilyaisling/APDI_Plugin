//
//  APDIHelpers.h
//  Effect & Synth Plugin Framework - Helper Objects / Functions
//
...
//        #pragma message("openResource not implemented")
//#if defined(_WIN32)
...
//#else
//        void openResource(std::string filename){
//            CFBundleRef plugBundle = CFBundleGetBundleWithIdentifier(CFSTR("com.UWE.EffectPlugin"));
...
//#pragma message("Wavetable operator= not implemented.")
...
//#pragma message("Wavetable generate not implemented.")
